...
import com.raphus.reggie.utils.SMSUtils;
import com.raphus.reggie.utils.ValidateCodeUtils;
...
public class UserController {
    ...
    public R<String> sendMsg(@RequestBody User user, HttpSession session){
        ...
        if(StringUtils.isNotEmpty(phone)){
            ...
            //SMSUtils.sendMessage("瑞吉外卖","您的验证码为：${code}，请勿泄露于他人！","15159065013",code);
